...
<body>
	...
	<div class="w3-bar w3-black">
		<a href="${urlHome}" class="w3-bar-item w3-button">Home</a> <a
			...
			Users</a> <a href="#" class="w3-bar-item w3-button">My Account</a> <a
			href="#" class="w3-bar-item w3-button"
			onclick="document.getElementById('logout').submit()">Logout</a> <a
			href="#" id="a" class="w3-bar-item w3-button">Check</a>
	</div>
	...
	<h3 align="center">Users Detail</h3>
